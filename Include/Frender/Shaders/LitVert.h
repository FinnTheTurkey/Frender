...
layout (location = 13) in vec4 lights1;\n\
layout (location = 14) in vec4 lights2;\n\
\n\
out vec2 tex_coords;\n\
out vec3 normal;\n\
out vec3 world_pos;\n\
\n\
out vec4 lights_part1;\n\
out vec4 lights_part2;\n\
\n\
out mat3 tbn;\n\
\n\
// uniform mat4 mvp;\n\
...
\n\
    lights_part1 = lights1;\n\
    lights_part2 = lights2;\n\
\n\
    // TBN matrix\n\
